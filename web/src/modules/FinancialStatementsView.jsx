...
/* ============================================================
   القوائم المالية — قسم المالية
   منقولة من النظام القديم (FinancialStatementsTab) إلى الـ Shell.
   قائمة الدخل + الميزانية العمومية من القيود المعتمدة (IFRS).
   getFinancialStatements يجلب tenantId من التوكن؛ نجلب اسم المنشأة للتصدير فقط.
   ============================================================ */
  ...
  return (
    <div style={styles.page}>
      <div style={styles.head}>
        ...
        <p style={styles.sub}>قائمة الدخل والميزانية العمومية من القيود المعتمدة (IFRS) · المالية</p>
      </div>
  ...
  return (
    <div style={styles.group}>
      ...
      {items.length === 0 ? (
        ...
        <div key={a.code} style={styles.gRow}>
...
const styles = {
  ...
  title: { margin: "0 0 6px", fontSize: 23, fontWeight: 700, color: "#059669", letterSpacing: "-.4px" },
  sub: { margin: 0, fontSize: 13, color: "#5a6580" },

  controls: { display: "flex", gap: 12, alignItems: "flex-end", flexWrap: "wrap", padding: 16, background: "#fff", border: "1px solid #e2e8f0", borderRadius: 10, marginBottom: 16 },
  ...
  genBtn: { padding: "10px 24px", fontSize: 14, fontWeight: 600, color: "#fff", background: "#059669", border: "none", borderRadius: 8, cursor: "pointer" },
  ...
  switchBtn: { padding: "10px 20px", fontSize: 14, fontWeight: 600, color: "#64748b", background: "#fff", border: "1px solid #e2e8f0", borderRadius: 8, cursor: "pointer" },
  switchActive: { color: "#fff", background: "#059669", borderColor: "#059669" },
  ...
  pdfBtn: { padding: "8px 16px", fontSize: 13, fontWeight: 600, color: "#059669", background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 8, cursor: "pointer" },

  group: { marginBottom: 18 },
  groupTitle: { fontSize: 15, fontWeight: 700, marginBottom: 8, paddingBottom: 6, borderBottom: "1px solid #f1f5f9" },
  gRow: { display: "flex", justifyContent: "space-between", padding: "7px 8px", fontSize: 14 },
  ...
  bsSectionTitle: { fontSize: 16, fontWeight: 700, color: "#059669", marginBottom: 10, paddingBottom: 6, borderBottom: "2px solid #f0fdf4" },
